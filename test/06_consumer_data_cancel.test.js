...
const { signData, getReqIdFromReceipt, generateRequestId, sleepFor } = require("./helpers/utils")
...
contract("Consumer - request cancellation tests", (accounts) => {
  const [admin, dataProvider1, dataConsumerOwner1, dataProvider2, dataConsumerOwner2, rando] = accounts

  const dataProvider1Pk = "0x6cbed15c793ce57650b9877cf6fa156fbef513c4e6134f022a85b1ffdd59b2a1"
  const dataProvider2Pk = "0x646f1ce2fdad0e6deeeb5c7e8e5543bdde65e86029e2fd9fc169899c440a7913"
  ...
  describe("basic request cancellation", function () {
    ...
    beforeEach(async function () {
      ...
      // add a dataProvider1
      await this.MockConsumerContract.addRemoveDataProvider(dataProvider1, fee, false, {
        from: dataConsumerOwner1,
      })
    ...
    it("dataConsumer (owner) can cancel a request - emits RequestCancellationSubmitted event", async function () {
      ...
      await this.MockConsumerContract.setRequestVar(REQUEST_VAR_REQUEST_TIMEOUT, 1, {
        from: dataConsumerOwner1,
      })

      // initialse request
      const reqReciept = await this.MockConsumerContract.requestData(dataProvider1, endpoint, gasPrice, {
        from: dataConsumerOwner1,
      })
    ...
    it("dataConsumer (owner) can cancel a request - Router emits RequestCancelled event", async function () {
      ...
      // initialse request
      const reqReiept = await this.MockConsumerContract.requestData(dataProvider1, endpoint, gasPrice, {
        from: dataConsumerOwner1,
      })
    ...
    it("request must have expired", async function () {
      ...
      await this.MockConsumerContract.setRequestVar(REQUEST_VAR_REQUEST_TIMEOUT, 100, {
        from: dataConsumerOwner1,
      })

      // initialse request
      const reciept = await this.MockConsumerContract.requestData(dataProvider1, endpoint, gasPrice, {
        from: dataConsumerOwner1,
      })
  ...
  describe("token and cancellation tests", function () {
    ...
    beforeEach(async function () {
      ...
      await this.MockConsumerContract1.setRouterAllowance(new BN(999999 * 10 ** 9), true, {
        from: dataConsumerOwner1,
      })
      await this.MockConsumerContract2.setRouterAllowance(new BN(999999 * 10 ** 9), true, {
        from: dataConsumerOwner2,
      })
      ...
      // add dataProvider1
      await this.MockConsumerContract1.addRemoveDataProvider(dataProvider1, c1p1Fee, false, {
        from: dataConsumerOwner1,
      })
      await this.MockConsumerContract2.addRemoveDataProvider(dataProvider1, c2p1Fee, false, {
        from: dataConsumerOwner2,
      })
      // add dataProvider2
      await this.MockConsumerContract1.addRemoveDataProvider(dataProvider2, c1p2Fee, false, {
        from: dataConsumerOwner1,
      })
      await this.MockConsumerContract2.addRemoveDataProvider(dataProvider2, c2p2Fee, false, {
        from: dataConsumerOwner2,
      })
      ...
      await this.MockTokenContract.transfer(this.MockConsumerContract1.address, initialContract1, {
        from: dataConsumerOwner1,
      })
      await this.MockTokenContract.transfer(this.MockConsumerContract2.address, initialContract2, {
        from: dataConsumerOwner2,
      })

      // set request timeout to 1 second
      await this.MockConsumerContract1.setRequestVar(REQUEST_VAR_REQUEST_TIMEOUT, 1, {
        from: dataConsumerOwner1,
      })
      await this.MockConsumerContract2.setRequestVar(REQUEST_VAR_REQUEST_TIMEOUT, 1, {
        from: dataConsumerOwner2,
      })
    })
    ...
    describe("basic tests", function () {
      it("single data cancellation success - ERC20 consumer contract balance remains 1000", async function () {
        // initialise request
        const reqReciept = await this.MockConsumerContract1.requestData(dataProvider1, endpoint, gasPrice, {
          from: dataConsumerOwner1,
        })
        const reqId = await getReqIdFromReceipt(reqReciept)
    ...
    describe("advanced tests", function () {
      describe("single consumer, multiple providers", function () {
        it("keep p1, cancel p2 - ERC20 balance of consumer contract is 900", async function () {
          ...
          const r1 = await this.MockConsumerContract1.requestData(dataProvider1, endpoint, gasPrice, {
            from: dataConsumerOwner1,
          })
          const reqIdP1 = getReqIdFromReceipt(r1)

          // initialise request2 from provider2
          const r2 = await this.MockConsumerContract1.requestData(dataProvider2, endpoint, gasPrice, {
            from: dataConsumerOwner1,
          })
      ...
      describe("multiple consumers, multiple providers", function () {
        it("c1 keep p1, cancel p2, c2 cancel p1 keep p2 - ERC20 balance of c1 contract is 900", async function () {
          ...
          const r3 = await this.MockConsumerContract2.requestData(dataProvider1, endpoint, gasPrice, {
            from: dataConsumerOwner2,
          })
          const reqIdC2P1 = getReqIdFromReceipt(r3)

          // initialise request4 from c2 for p2
          const r4 = await this.MockConsumerContract2.requestData(dataProvider2, endpoint, gasPrice, {
            from: dataConsumerOwner2,
          })
